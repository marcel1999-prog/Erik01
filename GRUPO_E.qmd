...
## somos estudiantes de octavo siclo del curso de programacion y analisis de datos, el contenido de la siguiente pagina web es el procesamiento de una base de tatos con diferentes pruevas estadisticas. 
